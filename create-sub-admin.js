...
window.addEventListener("load", function () {
    ...
    const subadminPage = 'sub-admin-dashboard.html';

    if (!referrer || !referrer.includes(subadminPage)) {
        alert("Access restricted. You must access this page from the sub-admin page.");
